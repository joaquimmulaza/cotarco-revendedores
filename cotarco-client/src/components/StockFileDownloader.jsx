...
const StockFileDownloader = () => {
  ...
  const handleDownload = async (fileId, fileName) => {
    ...
    try {
      setError('');
      await parceiroService.downloadStockFile(fileId, fileName);
    } catch (error) {
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="lg:ml-6">
                  <button
                    ...
                    className="w-full lg:w-auto my-bg-red text-white px-6 py-3 rounded-md hover: transition-colors cursor-pointer flex items-center justify-center font-medium disabled:bg-gray-400 disabled:cursor-not-allowed"
                  >
                    {downloading[file.id] ? (
                      <>
