...
// Check raw pivot table
$pivotCount = DB::table('category_product')->where('category_id', $categoryId)->count();
echo "Pivot table records for this category: {$pivotCount}\n";

$products = $category->products()->take(5)->get();
